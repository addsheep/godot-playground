...
func _enter_tree() -> void:
	...
	GlobalServiceRequests.increment_quest.connect(increment_quest)
	GlobalServiceRequests.get_active_quests.connect(_get_active_quests)


func _ready() -> void:
	GlobalServiceRequests.quest_manager_ready.emit(self)
...
func increment_quest(id: String, delta: int) -> void:
